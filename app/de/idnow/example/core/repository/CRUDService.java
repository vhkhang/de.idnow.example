...
public interface CRUDService<T extends Entity> {
	...
	/**
	 * Provide a service to update entity then return flushed item, the item itself should be signed before hand
	 * 
	 * @param obj
	 * @return
	 */
	...
	/**
	 * Provide a service to get entity by id. If there is no entity, result will be empty
	 * @param id
